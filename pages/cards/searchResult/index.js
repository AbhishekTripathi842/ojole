...
import { getPremiumCardsList } from "../../../api/CardsListAPI";
...
const SearchResultList = ({
  ...
  useEffect(() => {
    if (searchResponse.success) {
      ...
      setCardList(searchResponse.response.data);
    }
  }, [searchResponse]);
    ...
    <main>
      ...
      <div className="browse-all">
        <div className="browse-all-head">
          <label>Search Result: {router.query.searchData}</label>
        </div>
        <div className="browse-filter-container">
          Filter by:{router.query.searchData}
...
export default connect((state) => ({
  ...
  searchResponse: state.searchResultResopnse,
