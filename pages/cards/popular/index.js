...
import { getPopularCardsList } from "../../../api/CardsListAPI";
...
const PopularCardsList = ({ dispatch, popularCardsListResponse }) => {
    ...
    <main>
      ...
      <div className="browse-all">
        <div className="browse-all-head">
          <label style={{ textTransform: "uppercase" }}>Popular Ecards</label>
        </div>
